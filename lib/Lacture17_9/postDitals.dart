...
class PostDitales extends StatefulWidget {
  PostModel postModel;

  PostDitales(this.postModel);

  @override
  State<PostDitales> createState() => _PostDitalesState();
}

class _PostDitalesState extends State<PostDitales> {
  bool v= false;
  String? content="";
  bool isVis =false;
  @override
